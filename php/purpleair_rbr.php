...
// * Removed the sit$aq up checking, it slows the script and is redundant since the script will return an error anyways if it fails.
...
$TSID = "348386";
$TSKey = "17EHVBC669NPDDZ5";
$TSID2 = "348388";
$TSKey2 = "DDGV2RHU1P7RXCOZ";
...
$sensorstamp = date("d/m/y H:i", $timestamp/1000);
}
...
echo $sensorstamp;
echo "<br>";
echo round(GetZero(calculate($aq)));
echo "<br>";
echo $AQIrealtime;
echo "<br>";
echo getAQIDescription($AQIrealtime);
echo "<br>";
echo GetAQIMessage($AQIrealtime);
echo "<br>";
echo GetColorPm($aq)[0];
*/
...
// Gets respective color for the PM
function GetColorPm($aqnumber) {
	
global $useblending;

if ($aqnumber >= 350.0) {
    return array ($color = "#800000", $fcolor = "#FFFFFF");
  } else if ($aqnumber >= 150.0) {
    return array ($color = "#800080", $fcolor = "#FFFFFFF");
  } else if ($aqnumber >= 55.0) {
    return array ($color = "#FF0000", $fcolor = "#FFFFFFF");
  } else if ($aqnumber >= 35.0) {
    return array ($color = "#FF8C00", $fcolor = "#000000");
  } else if ($aqnumber >= 12.0) {
    return array($color = "#FFFF00", $fcolor = "#000000");
  } else if ($aqnumber >= 0.0) {
    return array($color = "#008000", $fcolor = "#FFFFFF");
  } else {
    return array($color = "#FFFFFF", $fcolor = "#000000");
  }
...
// Gets respective color for the Font
function GetColorFont($aqnumber) {
	
global $useblending;

if ($aqnumber >= 350.0) {
    return array ($color = "", $fcolor = "#FFFFFF");
  } else if ($aqnumber >= 150.0) {
    return array ($color = "#FFFFFF", $fcolor = "#FFFFFFF");
  } else if ($aqnumber >= 55.0) {
    return array ($color = "#FFFFFF", $fcolor = "#FFFFFFF");
  } else if ($aqnumber >= 35.0) {
    return array ($color = "#FFFFFF", $fcolor = "#000000");
  } else if ($aqnumber >= 12.0) {
    return array ($color = "#000000", $fcolor = "#000000");
  } else if ($aqnumber >= 0.0) {
    return array ($color = "#FFFFFF", $fcolor = "#FFFFFF");
  } else {
    return array ($color = "#FFFFFF", $fcolor = "#000000");
...
// Get LARAPA correction for PM2.5

function calculate($pm) {
  return 0.5 * $pm - 0.66;
}
