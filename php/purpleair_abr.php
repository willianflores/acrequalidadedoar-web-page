...
$TSID = "770694";
$TSKey = "BWIZGFV6LTP13MVS";
$TSID2 = "770696";
$TSKey2 = "MU8JIQBB6EFMM6FF";
...
$showtitle = 1;
$sensorname = "MPAC_ABR_01_promotoria";
...
if ($showdecimal == 1) {
	if ($aq1 + $aq2 < "1.0") {
	$aqabr = round(($aq1 + $aq2)/2,2);
} else {
	$aqabr = round(($aq1 + $aq2)/2,0);
...
$sensorstampabr = date("d/m/y H:i", $timestamp/1000);
}
...
function GetColorPmAbr($aqnumber) {
...
function GetColorFontAbr($aqnumber) {
...
function calculateAbr($pm) {
  return 0.5 * $pm - 0.66;
}


// Get zero correction
function GetZeroAbr($pm) {
