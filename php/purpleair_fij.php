...
$TSID = "684927";
$TSKey = "BFT1G0U8B4Y1F2T7";
$TSID2 = "684929";
$TSKey2 = "24EKYJM8VOSM5D8M";
...
$showtitle = 1;
$sensorname = "MPAC_FIJ_01_promotoria";
...
if ($showdecimal == 1) {
	if ($aq1 + $aq2 < "1.0") {
	$aqfij = round(($aq1 + $aq2)/2,2);
} else {
	$aqfij = round(($aq1 + $aq2)/2,0);
...
$sensorstampfij = date("d/m/y H:i", $timestamp/1000);
}
...
function GetColorPmFij($aqnumber) {
...
function GetColorFontFij($aqnumber) {
...
function calculateFij($pm) {
  return 0.5 * $pm - 0.66;
}


// Get zero correction
function GetZeroFij($pm) {
