...
$TSID = "717251";
$TSKey = "6B921HE3AUR24RGK";
$TSID2 = "717257";
$TSKey2 = "ATXE5UNAATMU9EK8";
...
$showtitle = 1;
$sensorname = "MPAC_BRL_01_promotoria";
...
if ($showdecimal == 1) {
	if ($aq1 + $aq2 < "1.0") {
	$aqbrl = round(($aq1 + $aq2)/2,2);
} else {
	$aqbrl = round(($aq1 + $aq2)/2,0);
...
$sensorstampbrl = date("d/m/y H:i", $timestamp/1000);
}
...
function GetColorPmBrl($aqnumber) {
...
function GetColorFontBrl($aqnumber) {
...
function calculateBrl($pm) {
  return 0.5 * $pm - 0.66;
}


// Get zero correction
function GetZeroBrl($pm) {
