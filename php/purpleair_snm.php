...
$TSID = "770671";
$TSKey = "Z5N4ONVNLJ05RBP8";
$TSID2 = "770673";
$TSKey2 = "2G5LDPJ1UEALT3V9";
...
$showtitle = 1;
$sensorname = "MPAC_SNM_02_promotoria";
...
if ($showdecimal == 1) {
	if ($aq1 + $aq2 < "1.0") {
	$aqsnm = round(($aq1 + $aq2)/2,2);
} else {
	$aqsnm = round(($aq1 + $aq2)/2,0);
...
$sensorstampsnm = date("d/m/y H:i", $timestamp/1000);
}
...
function GetColorPmSnm($aqnumber) {
...
function GetColorFontSnm($aqnumber) {
...
function calculateSnm($pm) {
  return 0.5 * $pm - 0.66;
}


// Get zero correction
function GetZeroSnm($pm) {
