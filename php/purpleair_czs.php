...
$TSID = "684827";
$TSKey = "T2Z2PS44UEJPQ642";
$TSID2 = "684829";
$TSKey2 = "PWO0H0MRQXMBW30F";
...
if ($showdecimal == 1) {
	if ($aq1 + $aq2 < "1.0") {
	$aqczs = round(($aq1 + $aq2)/2,2);
} else {
	$aqczs = round(($aq1 + $aq2)/2,0);
...
$sensorstampczs = date("d/m/y H:i", $timestamp/1000);
}
...
function GetColorPmCzs($aqnumber) {
...
function GetColorFontCzs($aqnumber) {
...
function calculateCzs($pm) {
  return 0.5 * $pm - 0.66;
}


// Get zero correction
function GetZeroCzs($pm) {
